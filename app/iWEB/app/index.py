...
def get_locations():
    ...
    # Loop through each type of location and append the data the front-end wants into the list.
    ...
    # Create the dictionary, identifying each type of location by its type as the key
